...
{/if}
	<div class="shopping_cart">
		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
			...
			<!--These are commented out so I can get rid of the cart text and just make a cart -->
			...
			<!--Commenting This gets rid of the parent product text, I only had to do this because certain screens were picky-->
